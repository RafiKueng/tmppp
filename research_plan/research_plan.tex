...
They offer the ability to address some of the currently most pressing questions in physics.
...
Currently running surveys will increase this number by 10 in the next 5 years, next gen surveys will increase it again by ten in the next 10 years.
But their detection is hard and requires much manual work, since software robots are not very good at it.
...
This proposal argues that volunteers will be essential for the next level of scientific analysis, the modelling of the lenses.
It proposes to extend the idea of SpaceWarps and involve the more experienced users in the modelling process.

It aims to build a inventory of all known and to be discovered lenses and associated models.
This inventory offers scientists to address many open topics.
This thesis will (i) address the the roles of dark matter and baryons in galaxies and (ii) to produce a catalogue of lensed quasars for follow up surveys.

The project will be set up as a science project, not as a game.
Volunteers joining will be educated about science and contribute as citizen scientists.
